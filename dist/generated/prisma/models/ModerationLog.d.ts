...
export type GetModerationLogAggregateType<T extends ModerationLogAggregateArgs> = {
    [P in keyof T & keyof AggregateModerationLog]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateModerationLog[P]> : Prisma.GetScalarType<T[P], AggregateModerationLog[P]>;
};
...
export type GetModerationLogGroupByPayload<T extends ModerationLogGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<ModerationLogGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof ModerationLogGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], ModerationLogGroupByOutputType[P]> : Prisma.GetScalarType<T[P], ModerationLogGroupByOutputType[P]>;
}>>;
export type ModerationLogWhereInput = {
    ...
    guildId?: Prisma.StringFilter<"ModerationLog"> | string;
    targetId?: Prisma.StringFilter<"ModerationLog"> | string;
    moderatorId?: Prisma.StringFilter<"ModerationLog"> | string;
...
export type ModerationLogScalarWhereWithAggregatesInput = {
    ...
    guildId?: Prisma.StringWithAggregatesFilter<"ModerationLog"> | string;
    targetId?: Prisma.StringWithAggregatesFilter<"ModerationLog"> | string;
    moderatorId?: Prisma.StringWithAggregatesFilter<"ModerationLog"> | string;
...
export type ModerationLogCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<ModerationLogFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ModerationLogDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['ModerationLog'];
        meta: {
            name: 'ModerationLog';
        };
    };
     ...
     * })
    **/
    count<T extends ModerationLogCountArgs>(args?: Prisma.Subset<T, ModerationLogCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], ModerationLogCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends ModerationLogGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, ModerationLogGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetModerationLogGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface ModerationLogFieldRefs {
    ...
    readonly guildId: Prisma.FieldRef<"ModerationLog", 'String'>;
    readonly targetId: Prisma.FieldRef<"ModerationLog", 'String'>;
    readonly moderatorId: Prisma.FieldRef<"ModerationLog", 'String'>;
