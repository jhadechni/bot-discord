...
export type GetUserActivityAggregateType<T extends UserActivityAggregateArgs> = {
    [P in keyof T & keyof AggregateUserActivity]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateUserActivity[P]> : Prisma.GetScalarType<T[P], AggregateUserActivity[P]>;
};
...
export type GetUserActivityGroupByPayload<T extends UserActivityGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<UserActivityGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof UserActivityGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], UserActivityGroupByOutputType[P]> : Prisma.GetScalarType<T[P], UserActivityGroupByOutputType[P]>;
}>>;
export type UserActivityWhereInput = {
    ...
    guildId?: Prisma.StringFilter<"UserActivity"> | string;
    userId?: Prisma.StringFilter<"UserActivity"> | string;
    xp?: Prisma.IntFilter<"UserActivity"> | number;
    level?: Prisma.IntFilter<"UserActivity"> | number;
    messageCount?: Prisma.IntFilter<"UserActivity"> | number;
    voiceMinutes?: Prisma.IntFilter<"UserActivity"> | number;
...
export type UserActivityWhereUniqueInput = Prisma.AtLeast<{
    id?: string;
    guildId_userId?: Prisma.UserActivityGuildIdUserIdCompoundUniqueInput;
    AND?: Prisma.UserActivityWhereInput | Prisma.UserActivityWhereInput[];
    OR?: Prisma.UserActivityWhereInput[];
    NOT?: Prisma.UserActivityWhereInput | Prisma.UserActivityWhereInput[];
    guildId?: Prisma.StringFilter<"UserActivity"> | string;
...
export type UserActivityScalarWhereWithAggregatesInput = {
    ...
    guildId?: Prisma.StringWithAggregatesFilter<"UserActivity"> | string;
    userId?: Prisma.StringWithAggregatesFilter<"UserActivity"> | string;
    xp?: Prisma.IntWithAggregatesFilter<"UserActivity"> | number;
    level?: Prisma.IntWithAggregatesFilter<"UserActivity"> | number;
    messageCount?: Prisma.IntWithAggregatesFilter<"UserActivity"> | number;
    voiceMinutes?: Prisma.IntWithAggregatesFilter<"UserActivity"> | number;
...
export type UserActivityOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "guildId" | "userId" | "xp" | "level" | "messageCount" | "voiceMinutes" | "createdAt" | "updatedAt", ExtArgs["result"]["userActivity"]>;
...
export type UserActivityCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<UserActivityFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface UserActivityDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends UserActivityCountArgs>(args?: Prisma.Subset<T, UserActivityCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], UserActivityCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends UserActivityGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, UserActivityGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetUserActivityGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface UserActivityFieldRefs {
    ...
    readonly guildId: Prisma.FieldRef<"UserActivity", 'String'>;
    readonly userId: Prisma.FieldRef<"UserActivity", 'String'>;
    readonly xp: Prisma.FieldRef<"UserActivity", 'Int'>;
    readonly level: Prisma.FieldRef<"UserActivity", 'Int'>;
    readonly messageCount: Prisma.FieldRef<"UserActivity", 'Int'>;
    readonly voiceMinutes: Prisma.FieldRef<"UserActivity", 'Int'>;
