...
export function buildShopNoticeEmbed(options) {
    const embedOptions = {
        title: options.title,
...
export function buildShopErrorEmbed(title, description) {
...
export function buildOrderReceivedEmbed(options) {
    const fields = [
...
export function buildInventoryEmbed(inventories) {
    const embed = buildAquarisEmbed({
...
export function buildLowStockEmbed(inventories) {
    return buildAquarisEmbed({
        title: 'Stock bajo',
...
export function buildShopStatsEmbed(options) {
    const fmt = (value) => value.toLocaleString('es-CO', { minimumFractionDigits: 0, maximumFractionDigits: 2 });
    const fields = [
...
//# sourceMappingURL=shop-ui.js.map