        ...
        try {
            ...
            if (interaction.isButton()) {
                ...
                if (customId.startsWith('apply_accept_') || customId.startsWith('apply_reject_')) {
                    ...
                    const hasPermission = actor.permissions.has(PermissionFlagsBits.Administrator) ||
                    ...
                    if (!hasPermission) {
                        await interaction.reply({
                            embeds: [
                                buildRecruitmentErrorEmbed('Permiso insuficiente', 'Solo el staff puede aceptar o rechazar solicitudes.'),
                            ],
                            ephemeral: true,
                        });
                        return;
