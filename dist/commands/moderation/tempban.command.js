    ...
    async execute(interaction) {
        ...
        if (member && !member.bannable) {
            await interaction.editReply({
                embeds: [
                    buildModerationErrorEmbed('⚠️ No se pudo aplicar el ban temporal', 'No puedo banear temporalmente a ese usuario por jerarquía, permisos o protección interna.'),
                ],
            });
            return;
        }
...
//# sourceMappingURL=tempban.command.js.map