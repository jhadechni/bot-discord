    ...
    async execute(interaction) {
        ...
        try {
            ...
            await interaction.editReply({
                embeds: [
                    buildModerationErrorEmbed('⚠️ No se pudo retirar el ban', 'No se encontró un ban activo o no tengo permisos para retirarlo.'),
                ],
            });
            return;
        }
...
//# sourceMappingURL=unban.command.js.map