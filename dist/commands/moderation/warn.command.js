...
import { MODERATION_COLORS, buildModerationLogEmbed, buildModerationStaffEmbed, buildModerationUserDmEmbed, buildModerationErrorEmbed, } from '../../utils/moderation-ui.js';
const WARN_LIMIT = 3;
    ...
    async execute(interaction) {
        ...
        if (!canWarn) {
            await interaction.editReply({
                embeds: [
                    buildModerationErrorEmbed('⚠️ No se pudo registrar la advertencia', 'No puedo advertir a ese usuario por jerarquía, permisos o protección interna.'),
                ],
            });
            return;
        }
...
//# sourceMappingURL=warn.command.js.map