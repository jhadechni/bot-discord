    ...
    async execute(interaction) {
        ...
        if (!target || !('kickable' in target) || !target.kickable) {
            await interaction.editReply({
                embeds: [
                    buildModerationErrorEmbed('⚠️ No se pudo aplicar la expulsión', 'No puedo expulsar a ese usuario por jerarquía, permisos o protección interna.'),
                ],
            });
            return;
        }
...
//# sourceMappingURL=kick.command.js.map