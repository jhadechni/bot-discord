...
export const pedidoCommand = {
    data: new SlashCommandBuilder()
        ...
        .setRequired(true)))
        .addSubcommand(sub => sub.setName('carrito').setDescription('Abre tu carrito interactivo para crear un pedido')),
